...
internal static class SpecialFormAssignment
{
    ...
    static string AssignmentVariable(PairExpression list) => ((VariableExpression)list.Cadr).Value;
    static Expression AssignmentValue(PairExpression list) => list.Caddr;
